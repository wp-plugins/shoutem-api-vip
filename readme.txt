...
ShoutEm API Wordpress plugin serves as a connector between your Wordpress site and the mobile application build on ShoutEm. It exposes a REST API that allows your users to read blog posts from your site directly from your mobile application. This version is intended for sites hosted on wordpress.org. If you hve a self-hosted site, take a look at http://wordpress.org/plugins/shoutem-api
